...
const lionGeneticsProfile = {
  ...lionProfile,
  genetics: "diverse",
};
console.log(`Lion Profile: ${lionProfile}`);
console.log(`Full lion profile(w/ genetics: ${lionGeneticsProfile})`);
/*
 * Observations: Making changes to the genetics property in copyLion Profile modifies the same property in the lionProfile as well.
 * TODO: Explain here.
 * Making changes to the lion genetics property in the copied version only creates a new top level object, but nested objects are still referenced.
 */
...
/*
 * Observations: Making changes to a nested property,in a shallow copy, will also affect the the orignal copy
 * TODO: Explain here.
 * Objects are not directly duplicated but a reference for the same object.
 */
